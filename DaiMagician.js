phina.define('DaiMagician', {
    ...
    init: function() {
      ...
      this.sprite = Sprite('daimagician').addChildTo(this);
    ...
    shot :function(){
      ...
      var fireball = DaiFireBall(this.x,this.y,this.attack).addChildTo(GameMain.enemyGroup);

      var self = this;
      this.tweener.clear()
      .wait(100)
      .call(function() {
         var fireball = DaiFireBall(self.x,self.y,self.attack).addChildTo(GameMain.enemyGroup);
      }, this)
      .wait(100)
      .call(function() {
        var fireball = DaiFireBall(self.x,self.y,self.attack).addChildTo(GameMain.enemyGroup);
    ...
    knockBack :function(){
      ...
      if(this.timer % 2 ==0){
          ...
          var ai = DaiMagicianAfterimage().addChildTo(GameMain.afeterGroup);
...
//      this.mode_hozon = this.mode;
  ...
  phina.define('DaiMagicianAfterimage', {
    superClass: 'Sprite',
  
    init: function() {
      this.superInit('daimagician');
      this.alpha = 0.6;
