phina.define('BlackKnight', {
    ...
    init: function() {
      ...
      this.weponSprite = Sprite("redsord").addChildTo(this.sprites);
      ...
      this.sprite = Sprite('blackknight').addChildTo(this.sprites);
      ...
      //倍率
      this.hpMagnification = 2.1;
      this.attackMagnification = 1.3;
      this.expMagnification = 11;
      this.setLevel();
    ...
    move :function(frame){
      ...
      switch (this.mode) {
        ...
        case "attack":
            ...
            if (frame % 2 === 0) {
                var ai = BlackKnightAfterimage().addChildTo(GameMain.afeterGroup);
    ...
    shot :function(){
        ...
        this.kaitenEffect = Sprite('kaitenred').addChildTo(this);
...
phina.define('BlackKnightAfterimage', {
superClass: 'Sprite',

init: function() {
    this.superInit('blackknight');
